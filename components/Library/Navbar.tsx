...
export default function LibraryNavbar({ handleTagDelete, handleTagFilter, handleSearch, onSearch, tags, onTagFilter, onDeleteTag, selectedTags, userStatus }: LibraryNavbarProps) {
  ...
  return (
    <motion.nav transition={{duration: 0.45, ease: "easeInOut"}} animate={hidden ? 'hidden' : 'visible'} variants={{visible: {y: 0}, hidden: {y: "-100%"}}} className="z-50 sticky bg-[#060606] bg-opacity-90 py-3 backdrop-blur-md top-0 flex flex-col gap-4">
