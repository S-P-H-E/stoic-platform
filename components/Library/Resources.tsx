...
export default function Resources({isPremium, userStatus, userId}: { isPremium: boolean, userStatus: string | undefined, userId: string | null }) {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            />
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 3xl:grid-cols-4 4xl:grid-cols-5 5xl:grid-cols-6 gap-5">
                {searchQuery && filteredResources.length === 0 ? (
                    ...
                    filteredResources.map((resource, index) => (
                        ...
                        >
                            {areResourcesLoading ? (
                                <div className="h-[27rem] w-full animate-pulse rounded-xl bg-border"/>
                            ) : (
                                <Resource
