        ...
        <div className="w-full h-2/6 px-8 md:px-12 py-2">
          <div className='2xl:p-8 md:p-4 p-4 px-0 flex items-center justify-between gap-4'>
            <div className="flex items-center gap-4">
              <div className='rounded-full bg-white 2xl:w-32 2xl:h-32 md:h-24 md:w-24 h-20 w-20 '></div>
                <div>
              ...
              <Button className='bg-red-600 hover:bg-red-500 lg:font-semibold 2x:text-lg md:text-base gap-3'>
                Log Out
                <BiLogOut/>
              </Button>
            </div>
          ...
          <div className='flex flex-col md:mt-6 2xl:mt-16 md:text-2xl 2xl:text-3xl font-semibold gap-2'>
            ...
            <div className="2xl:mb-8 md:mb-0 mb-0 gap-2 flex flex-col w-64 2xl:h-32 h-[6.7rem]">
              <h1>Password</h1>
              <Button className='font-normal text-lg'>Change Password</Button>
            </div>

            <div className="md:w-40 items-center justify-center lg:hidden">
              <Button className='bg-red-600 hover:bg-red-500 font-normal 2x:text-lg md:text-base'>
                Log Out
                <BiLogOut/>
              </Button>
            </div>
