...
export default function AllCourses() {
  return (
    <div className='flex flex-col p-4 bg-[--darkgray] items-center gap-4 hover:border-[#585757] border border-[--border] h-full min-h-[56vh] transition duration-200 rounded-xl relative'>
