...
export default function SkeletonLesson() {
  return (
    ...
    <div className='h-[35px] w-[500px] bg-[#252525] rounded-lg mb-2 animate-pulse'/>
    <div className='flex'>
    <div className='bg-[#252525] rounded-3xl shadow-2xl animate-pulse w-full h-full aspect-video' />
