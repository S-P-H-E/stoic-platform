...
export default function DashboardCourse({ image, href, name, description }: DashboardCourseProps) {
  return (
    ...
    <div className="relative group-hover:scale-110 transition duration-300 h-full">
        <div className="absolute top-[60%] left-0 w-full h-48 group-hover:scale-105 bg-gradient-to-b from-transparent via-[#161515] to-[#161515] rounded-xl z-30"/>
    ...
    <div className='flex items-center justify-center w-full h-full text-center p-4'>
        <h1 className="text-xl 2xl:text-2xl z-50">{name}</h1>
    </div>
