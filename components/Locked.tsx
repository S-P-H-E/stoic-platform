...
export default function Locked() {
    return (
        <div className="md:pl-[15rem] lg:pl-[18rem] fixed inset-0 backdrop-blur-xl w-full h-full flex items-center justify-center z-40">
            <div className="bg-bg/70 absolute inset-0 w-full h-full"/>
