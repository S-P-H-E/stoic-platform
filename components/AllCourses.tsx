...
export default function AllCourses() {
  return (
    <div className='flex flex-col p-4 bg-[#161515] items-center gap-4 hover:border-[#585757] border border-[--border] h-full transition duration-200 rounded-xl relative'>
