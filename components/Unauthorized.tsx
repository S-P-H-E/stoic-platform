...
export default function Unauthorized({locked, customMsg}: {customMsg?: string, locked?: boolean}) {
  return (
    <div className='flex flex-col min-h-screen items-center justify-center gap-3 p-8'>
      ...
      <h3 className='text-2xl font-medium text-center'>{customMsg ? customMsg : 'You do not have permission to view this content'}</h3>
      <Link href="/">
