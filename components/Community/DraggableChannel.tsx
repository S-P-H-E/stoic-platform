...
<motion.div
  ...
  style={{ width: '100%' }}
>
  <div onClick={() => {if (!isDragging) {onClick();}}} className={clsx('px-4 hover:cursor-pointer py-2 text-lg bg-[--darkgray] border border-[--border] rounded-xl hover:bg-[--border] transition', channelId == channel.id && 'bg-white hover:bg-white/80 text-black')}>
