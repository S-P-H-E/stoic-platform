import AllCourses from '@/components/oldDashboard/AllCourses';
import Continue from '@/components/oldDashboard/Continue';
import DateTime from '@/components/oldDashboard/Date';
import Tools from '@/components/oldDashboard/Tools';
