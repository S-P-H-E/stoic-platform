...
export default function SettingsComponent({
  ...
  const { userSocial, userDescription, userStripeId, userRoles, generalLastCourse, userEmail, generalLastLesson, userName, userStatus, userProfileImageUrl, userProfileBannerUrl, userOnboarding } = UserDataFetcherById(userId);
